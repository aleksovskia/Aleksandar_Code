    ...
    public class FacultyHelpers
    {
        public Faculty CreateFaulty(string name)
        {
            ...
            var phdSubjects = new List<Subject>() {
                ...
                new Subject("Fizika",10),
                new Subject("Kalkulus2",8) ,
                new Subject("Matematika2",10)
            };
